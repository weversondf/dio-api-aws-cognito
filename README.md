...
- Protocol - REST -> Create new API -> API name [dio-api-aws-cognito] -> Endpoint Type - Regional -> Create API
...
- Domain name -> Domain prefix [dio-api-aws-cognito] -> Save
...
- Auth URL [https://dio-api-aws-cognito.auth.sa-east-1.amazoncognito.com/login]
